package org.ganjp.gmsw.demo.controller;
...
import org.ganjp.gmsw.common.util.MaskFormat;
import org.ganjp.gmsw.demo.model.FirstJavaBean;
import org.ganjp.gmsw.demo.model.SocialSecurityNumber;
import org.ganjp.gmsw.demo.model.User;
...
public class SpringController {
	...
	public @ResponseBody String byPathPattern(HttpServletRequest request) {
		return "Mapped by path pattern ('" + request.getRequestURI() + "')"; //('/gmsw/spring/mapping/path/ganjp')
	}
	@RequestMapping(value="/mapping/parameter", method=RequestMethod.GET, params="!foo") // or params="!foo", /gmsw/spring/mapping/parameter?foo=bar
	...
	public @ResponseBody Channel writeChannel() {
		...
		channel.setLink("http://localhost:8080/gmsw/spring/messageconverters/rss");
		return channel;
	}
	//-------------------------------- Type Converters ---------------------------------------
