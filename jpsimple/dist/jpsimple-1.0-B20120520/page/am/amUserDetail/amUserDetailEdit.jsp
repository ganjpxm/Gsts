...
<div class="main">
  <div id="search" class="dp100 mt1">	
    <form id="amUserDetailForm" action="<c:url value='/servlet/amUserDetail?action=edit'/>" method="post">
      ...
      <table id="amUserDetailTable" class="table">
  	    ...
  	    <tbody class="formEdit">  
			...
			<td><input id="fieldName1" name="fieldName1" value="<c:out value='${amUserDetail.fieldName1}'/>"/></td>
			<th><span style="color:red">*</span><fmt:message key="amUserDetail.fieldName2"/>:</th>
			<td><input id="fieldName2" name="fieldName2" value="<c:out value='${amUserDetail.fieldName2}'/>"/></td>
			<th><span style="color:red">*</span><fmt:message key="amUserDetail.fieldName3"/>:</th>
			<td><input id="fieldName3" name="fieldName3" value="<c:out value='${amUserDetail.fieldName3}'/>"/></td>
	      </tr>
	    </tbody>  
	    <tfoot>
		  <tr>
