...
<body>
  <div id="content" class="dp100 ml2" style="text-align:left">
  	<form id="cmArticleForm" action="<c:url value='/servlet/cmArticle?action=toArticleTitle&articleCategoryIds=${articleCategoryIds}'/>" method="post" >
	    ...
	    <c:forEach var="model" items="${page.result}">
		  <tr>
		    <td style="height:40px;font-weight:bolder;font-size:14px;font-color:black; padding-left:60px;">
			  <a href="<c:url value='/servlet/cmArticle?action=toArticleContent&articleId=${model.articleId}&articleCategoryIds=${articleCategoryIds}'/>">
