...
<div class="main">
  <div id="content" class="dp100 mt1">	
    <form id="emProductForm" action="<c:url value='/servlet/emProduct?action=add'/>"  method="post">
      <table id="emProductTable" class="table">
	      ...
	      <tr>
			...
			<td><input id="publishName" name="publishName"/></td>
			<th><span style="color:red">*</span><fmt:message key="emProduct.publishDate"/>:</th>
			<td><input id="publishName" name="publishDate"/></td>
	      </tr>
	      <tr>
	        <th><span style="color:red">*</span>product picture:</th>
	      	<td colspan="3" >
	      	  ...
	      	  <img name="showimg" id="showimg" src="" style="display:none;" alt="preview" height="80" width="80"/>
	      ...
	      <tr>
		    ...
		    <td colspan="3">
			  <textarea id="description" name="description" class="tinymce" rows="23" cols="65"></textarea>
		    </td>
	      </tr>
	    </tbody>  
	    <tfoot>
		  <tr>
		    <td colspan="4" >
			  ...
			  <input type="button" onclick="window.location = '<c:url value='/servlet/emProduct?action=toList'/>'" 
