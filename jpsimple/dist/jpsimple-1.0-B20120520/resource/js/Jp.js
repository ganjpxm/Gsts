...
Jp.datatables = {
  oLanguage: {
    ...
    sEmptyTable: I18N.emptyTable,
    sInfo: String.format(I18N.displayRecords, "_START_", "_END_", "_TOTAL_"),
    sInfoEmpty: I18N.emptyTable,
    sInfoFiltered: String.format(I18N.infoFiltered, "_MAX_"),
    sSearch: I18N.search,  
        oPaginate: { sFirst: I18N.firstPage, sPrevious: I18N.previousPage, sNext: I18N.nextPage, sLast: I18N.lastPage}
   }
}

/**
 * typeof param === 'boolean' //number,boolean,string,object,undefined,function
