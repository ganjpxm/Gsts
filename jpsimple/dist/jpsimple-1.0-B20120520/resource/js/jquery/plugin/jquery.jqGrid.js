 ...
 * Date: 2011-07-20
 * 1764: table的样式删除掉table-layout:fixed;
 * 7783：增加navGridposition方法
 * 8080，8132: 新增在toppager增加：if($t.p.toppager){ findnav = $("#"+$t.p.id+"_toppager .navtable")[0];}
 * 7879：在每个按钮之后增加空格：$("tr",navtbl).append("<td>&nbsp;</td>");
 */
//jsHint options
...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
        ...
        setPager = function (pgid, tp){
			...
			$("#"+$.jgrid.jqID(pgid) )
			.append("<div id='"+pgcnt+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;height:100%;' role='row'><tbody><tr><td id='"+lft+"' align='left'></td><td id='"+cent+"' align='center' style='white-space:pre;'></td><td id='"+rgt+"' align='right'></td></tr></tbody></table></div>")
