var tinyMCE_GZ = {
	...
	loadScripts : function(co, th, pl, la, cb, sc) {
		...
		// Build query string
		q = 'js=true&compress=false&diskcache=' + (s.disk_cache ? 'true' : 'false') + '&core=' + (co ? 'true' : 'false') + '&suffix=' + escape(s.suffix) + '&themes=' + escape(th) + '&plugins=' + escape(pl) + '&languages=' + escape(la);
