//$Id: AbstractUUIDGenerator.java,v 1.2 2010/09/07 09:46:40 zhaoqy Exp $
package org.ganjp.core.db.id;


import java.net.InetAddress;

import org.ganjp.core.util.BytesUtil;

/**
 * The base class for identifier generators that use a UUID algorithm. This class
 * implements the algorithm, subclasses define the identifier format.
 * 
