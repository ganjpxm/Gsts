...
import org.ganjp.core.util.ClassUtil;
import org.ganjp.core.util.ObjectUtil;
...
public class ClassPathResource extends AbstractResource {
	 ...
	 * @see java.lang.ClassLoader#getResourceAsStream(String)
	 * @see org.springframework.util.ClassUtil#getDefaultClassLoader()
	 */
	 ...
	 * @see org.springframework.util.ResourceUtil#getFile(java.net.URL, String)
	 */
	public File getFile() throws IOException {
		return ResourceUtil.getFile(getURL(), getDescription());
	}
	...
	protected File getFileForLastModifiedCheck() throws IOException {
		...
		if (ResourceUtil.isJarURL(url)) {
			...
			return ResourceUtil.getFile(actualUrl);
		}
		else {
	 ...
	 * @see org.springframework.util.StringUtil#applyRelativePath(String, String)
	 */
	 ...
	 * resource refers to.
	 * @see org.springframework.util.StringUtil#getFilename(String)
	 */
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ClassPathResource) {
			...
			return (this.path.equals(otherRes.path) &&
					ObjectUtil.nullSafeEquals(this.classLoader, otherRes.classLoader) &&
					ObjectUtil.nullSafeEquals(this.clazz, otherRes.clazz));
		}
		return false;
	}
