...
public class DefaultResourceLoader implements ResourceLoader {
	...
	private static class ClassPathContextResource extends ClassPathResource implements ContextResource {
		...
		public Resource createRelative(String relativePath) {
			String pathToUse = StringUtil.applyRelativePath(getPath(), relativePath);
			return new ClassPathContextResource(pathToUse, DefaultResourceLoader.class.getClassLoader());
		}
	}
