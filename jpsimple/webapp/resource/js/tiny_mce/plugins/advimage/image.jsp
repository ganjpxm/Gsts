		  ...
		  <table role="presentation" class="properties">
			<tr>
			  ...
			  <td colspan="2">
				  ...
				  <tr> 
					<td><input id="src" name="src" type="text" id="src" value="" class="mceFocus" onchange="ImageDialog.showPreviewImage(this.value);" aria-required="true" /></td> 
		...
		<fieldset>
		  ...
		  <table role="presentation" border="0" cellpadding="4" cellspacing="0" width="100%">
			...
			<tr>
			  ...
			  <td>
			    <select id="over_list" name="over_list" 
			...
			<tr>
			  ...
			  <td>
			    <select id="out_list" name="out_list" 
